...
namespace Backend
{
	...
	void Example()
	{
		...
		std::string response;
		api->Request(EReqType_GET, "https://api-v1-public-service.prod.fluxapp.dev/api/public/matchmaker", Body, &response);
	}
	...
	void Example_DELETE()
	{
		...
		api->Request(EReqType_DELETE, "https://api-v1-public-service.prod.fluxapp.dev/api/public/matchmaker", Body);
	}
}