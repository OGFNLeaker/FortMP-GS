...
namespace Globals
{
	// std::string PlaylistName = "Playlist_Playground.Playlist_Playground"; // Playground
	std::string PlaylistName = "Playlist_DefaultSolo.Playlist_DefaultSolo"; // Solo
	// std::string PlaylistName = "Playlist_Low_Solo.Playlist_Low_Solo"; // One Shot Solo
	// std::string PlaylistName = "Playlist_Fill_Solo.Playlist_Fill_Solo"; // Floor Is Lava Solo
	bool bLategame = true;
}
